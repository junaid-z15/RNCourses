      ...
      <Stack.Navigator
        ...
        <Stack.Screen
          ...
          options={{
            ...
            // headerMid:() => (
            //   <Text   style={{justifyContent:"center",alignSelf:"center",backgroundColor:'red'}} >LeadSol Bootcamp</Text>
            // ),
            headerRight: () => (
              <Image
                style={{height: 40, width: 40, marginRight: 20,borderRadius:20}}
                source={require('./app/src/assets/junaid.png')}
              />
            ),
          }}
        />
